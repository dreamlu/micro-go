...
import (
	"demo/base-srv/controllers/admin"
	"demo/base-srv/controllers/admin/applet"
	"demo/base-srv/controllers/admin/setup/freight"
	"demo/base-srv/controllers/admin/setup/freight/freight_city"
	"demo/base-srv/controllers/admin/setup/logistic"
	"demo/base-srv/controllers/ali/sms"
	"demo/base-srv/controllers/carousel"
	"demo/base-srv/controllers/client"
	"demo/base-srv/controllers/client/address"
	"demo/base-srv/controllers/client/cart"
	"demo/base-srv/controllers/goods"
	"demo/base-srv/controllers/goods/category"
	"demo/base-srv/controllers/goods/notice"
	"demo/base-srv/controllers/goods/regroup"
	"demo/base-srv/controllers/goods/warehouse"
	"demo/base-srv/controllers/module"
	"demo/base-srv/controllers/order"
	"demo/base-srv/controllers/order/comment"
	"demo/base-srv/controllers/order/order_refund"
	"demo/base-srv/controllers/order/order_refund/info"
	"demo/base-srv/controllers/pca"
	"demo/base-srv/controllers/record"
	"demo/base-srv/controllers/wx"
	"demo/base-srv/routers"
	"demo/commons/controllers/delivery"
)
